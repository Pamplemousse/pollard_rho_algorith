...
\begin{document}
  ...
  \begin{frame}{Le lièvre et la tortue}
    ...
    \begin{figure}
            \center{}
            \includegraphics[scale=0.5]{../rapport/Floyd.png}
  ...
  \begin{frame}{Méthode des points distingués}
    \begin{itemize}
        ...
        \item choisir $x \in G$ aléatoirement, lancer la fonction d'itération jusque tomber sur un point distingué, le stocker et réitérer le procédé
