\chapter{Optimisations}
    ...
    \section{Méthode des points distingués}
      ...
      Le graphe obtenu (figure \ref{fig:r_adding_walks_and_distinguished_points_results}) met en évidence que la méthode des points distingués n'a pas changé que la complexité de l'algorithme, toujours est en $\mathcal{O}(\sqrt{q})$.
