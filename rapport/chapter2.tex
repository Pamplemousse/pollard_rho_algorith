\chapter{Implémentation «\texorpdfstring{\,}{\ }classique\texorpdfstring{\,}{\ }»}
    ...
    \section{Tests et mesures}
      ...
      \begin{itemize}
        ...
        \item Isolated ou Independent : les tests ne sont pas reliés entre eux, ne contiennent pas d'effets de bords affectant les autres. Nécessaire pour tester de petites unités de notre programme de façon isolée.
